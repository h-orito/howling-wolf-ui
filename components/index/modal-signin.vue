  ...
  >
    <div class="modal-card">
      <header class="modal-card-head">
        <p class="modal-card-title has-text-left">ログイン</p>
      </header>
        ...
        <div class="content">
          ...
          <div class="m-t-3 m-b-3">
            ...
            <b-button
              type="is-primary"
              size="is-small"
              @click="$emit('signin-with-twitter')"
            >
              Twitterログイン
            </b-button>
            <p>
              Twitter仕様変更に伴い、2023/06以前のアカウントではログインできなくなりました。<br />
              以前と同アカウントでログインしても、新規アカウントとして登録されます。<br />
