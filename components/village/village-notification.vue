<template>
  <div class="village-notification" :class="className">
    <slot />
  </div>
</template>
...
export default class VillageNotification extends Vue {
  @Prop({ type: String })
  private type!: string
