<template>
  <div>
    <div class="menu-area">
      <div class="m-b-50">
        <p class="is-size-5 spotlight-shadow">その他情報</p>
      </div>
      <div class="columns">
    ...
    <kampa-modal :is-open="isKampaModalOpen" @close-modal="closeKampaModal" />
    <term-modal :is-open="isTermModalOpen" @close-modal="closeTermModal" />
    <policy-modal
