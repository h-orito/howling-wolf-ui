...
export default class extends Vue {
  ...
  private get participatingVillages(): SimpleVillage[] {
    ...
    const progressVillages =
      this.myselfPlayer.participate_progress_villages.list
    const epilogueVillages =
      this.myselfPlayer.participate_finished_villages.list.filter(
